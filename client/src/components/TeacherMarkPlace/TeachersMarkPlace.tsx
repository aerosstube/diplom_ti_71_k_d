...
const TeachersMarkPlace: FC <TeacherMarkPlaceProps>= ({teacherUser}) => {
    const data=[{dateOfLesson:'21.03.1994',studentName: 'Буханов Д.Д.', markOfLesson: [5,4,5]},{dateOfLesson:'210394',studentName: 'Валетов С.А.', markOfLesson: [5,3,2]},{dateOfLesson:'210394',studentName: 'Васюнин Т.А.', markOfLesson: [5,5,2]}]
                        ...
                        <TableRow>
                            <StyledTableCell>{date.studentName}</StyledTableCell>
                            {
                                date.markOfLesson.map((mark)=>
                                    <StyledTableCell>{teacherUser ? <input className={cl.inp} pattern='2|3|4|5|[Нн]|[Бб]' defaultValue={mark}/> : <input className={cl.inp} disabled pattern='2|3|4|5|[Нн]|[Бб]' defaultValue={mark}/>}</StyledTableCell>
                                )
                            }
                        </TableRow>
                    )}
